...
// Vendor-specific name and version of the RTI implementation
  RTI_EXPORT const char * RTIname(); 
  RTI_EXPORT const char * RTIversion(); // identical to MOM attributes of same name
...
operator << (RTI_STD::ostream &, rti13::Exception *);

RTI_STD::ostream RTI_EXPORT & 
operator << (RTI_STD::ostream &, rti13::Exception const &);

RTI_STD::ostream RTI_EXPORT & 
operator << (RTI_STD::ostream &, const rti13::FedTime &);
